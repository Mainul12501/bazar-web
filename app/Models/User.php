...
//        'email',
    ...
    public static function createOrUpdateUser($request, $id = null)
    {
        return User::updateOrCreate(['id' => $id], [
            ...
            'role'  => count(User::where('role', 'admin')->get()) > 0 ? 'user' : 'admin',
            ...
            'profile_photo_url' => imageUpload($request->file('profile_image'), 'profile-image',150,150, isset($id) ? User::find($id)->profile_photo_url : '')
        ]);
    }
